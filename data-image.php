                        ...
                        if (mysqli_num_rows($foto) > 0) {
                            while ($row = mysqli_fetch_array($foto)) { ?>
                                <tr>
                                    ...
                                    <td><a href="foto/<?php echo $row['image_varchar'] ?>" target="_blank"><img src="foto/<?php echo $row['image_varchar'] ?>" width="50px"></a></td>
                                    <td><?php echo ($row['image_status'] == 0) ? 'Tidak Aktif' : 'Aktif'; ?></td>
                                    <td><a href="edit-image.php?id=<?php echo $row['image_id'] ?>">Edit</a> ||
